				...
				<div
					...
					<c:if test="${params2.currentUser.mem_access == 0}">
						<div class="form-group">
							<label for="cls_code">강의코드: ${params1.selCls.cls_code}</label>
						...
						<div class="form-group">
							<label for="cls_category">카테고리: ${params1.selCls.cls_category}</label>		
						...
						<div class="form-group">
							...
							value="${params1.selCls.cls_name}" required/>
						</div>
						<br>
						<div class="form-group">
							<label for="mem_code">강사코드: ${params1.selCls.mem_code}</label>
							<input type="hidden" class="form-control" 
							name="mem_code" id="mem_code"
							value="${params1.selCls.mem_code}" required/>
						</div>
						<br>
						<div class="form-group">
							...
							value="${params1.selCls.cls_price}" required/>
						</div>
						<br>		
						<div class="form-group">
							...
							value="${params1.selCls.cls_time}" required/>
						</div>
						<br>
						<div class="form-group">
						<c:if test="${params1.selCls.cls_delete == 1}">
							<label for="cls_delete">삭제여부: 아니오</label>
						</c:if>
						<c:if test="${params1.selCls.cls_delete == 0}">
						...
						<div class="form-group">
							...
							value="${params1.selCls.cls_period}" required/>
						</div>
						<br>
						<div class="form-group">
							...
							placeholder="강의 소개 및 내용을 입력하세요." required>${params1.selCls.cls_content}</textarea>
						</div>
						<br>
						<div class="form-group">
							<label for="cls_img">이미지파일이름: ${params1.selCls.cls_img}</label>
							<input type="hidden" class="form-control"
							name="cls_img" id="cls_img"
							value="${params1.selCls.cls_img}" required/>
						</div>
						<br>
						<div class="form-group">
						...
						<div class="form-group">
							...
							placeholder="Youtube 공유의 퍼가기 내용을 복사 후 붙여넣어 주세요." required>${params1.selCls.cls_url}</textarea>
						</div>				
